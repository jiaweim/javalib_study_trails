...
public class CliTest
{
    ...
    public void testSimpleShort() throws Exception
    {
        ...
        assertEquals(cl.getOptionValue("b"), "toast", "Confirm arg of -b");
        assertEquals(cl.getArgList().size(), 2, "Confirm size of extra args");
    }
    ...
    public void testSimpleLong() throws Exception
    {
        ...
        assertTrue(cl.hasOption("b"), "Confirm -b is set");
        assertEquals(cl.getOptionValue("b"), "toast", "Confirm arg of -b");
        assertEquals(cl.getOptionValue("bfile"), "toast", "Confirm arg of --bfile");
        assertEquals(cl.getArgList().size(), 2, "Confirm size of extra args");
    }
