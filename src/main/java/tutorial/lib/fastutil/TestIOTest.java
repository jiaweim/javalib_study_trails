...
public class TestIOTest
{
    ...
    public void testBytes(byte[] a) throws IOException
    {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            switch (i) {
                case 0:
                    TextIO.storeBytes(a, file);
                    break;
                case 1:
                    TextIO.storeBytes(a, new PrintStream(file));
                    break;
                case 2:
                    TextIO.storeBytes(aShifted, 1, a.length, file);
                    break;
                case 3:
                    TextIO.storeBytes(aShifted, 1, a.length, new PrintStream(file));
                    break;
            }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            switch (i) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    TextIO.storeBytes(aShifted, 1, length, file);
                    break;
                case 3:
                    TextIO.storeBytes(aShifted, 1, length, new PrintStream(file));
                    break;
            }
