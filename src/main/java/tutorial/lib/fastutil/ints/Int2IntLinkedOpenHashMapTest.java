...
//    }
    ...
    protected static void test(int n, float f) throws IOException, ClassNotFoundException
    {
        ...
        for (int i = 0; i < n; i++) {
            ...
            assertFalse((m.get(T) != (0)) != ((t.get((Integer.valueOf(T))) == null ? (0) : (((t.get((Integer.valueOf
        ...
        for (int i = 0; i < 20 * n; i++) {
            int T = genKey();
            int U = genValue();
            assertTrue(valEquals(m.put((Integer.valueOf(T)), (Integer.valueOf(U))), t.put((Integer.valueOf(T)),
                    (Integer.valueOf(U)))));
            T = genKey();
            assertTrue(valEquals(m.remove((Integer.valueOf(T))), t.remove((Integer.valueOf(T)))));
        }
        assertTrue(m.equals(t));
        assertTrue(t.equals(m));
        ...
        /* Now we play with iterators. */
        {
            ...
            for (int k = 0; k < 2 * n; k++) {
                ...
                if (r.nextFloat() < .8 && i.hasNext()) {
                    assertTrue((E = (Map.Entry<Integer, Integer>) i.next()).getKey().equals(J = (F = (Map
                            .Entry<Integer, Integer>) j.next()).getKey()));
                    if (r.nextFloat() < 0.3) {
                        i.remove();
                        j.remove();
                        t.remove(J);
                    ...
                    assertTrue((E = (Map.Entry<Integer, Integer>) i.previous()).getKey().equals(J = (F = (Map
                            .Entry<Integer, Integer>) j.previous()).getKey()));
                    if (r.nextFloat() < 0.3) {
                        i.remove();
                        j.remove();
                        t.remove(J);
         ...
         */
        {
            ...
            for (int k = 0; k < 2 * n; k++) {
                ...
                int rU = m.put(T, U);
                assertTrue(dr == (m.defaultReturnValue()
                        != rU));
                if (1 == (r.nextInt(2) % 2)) {
            ...
            assertTrue(new java.util
                    .ArrayList<Object>(m.keySet()).equals(new java.util.ArrayList<Integer>(d)));
        }
        m.clear();
        t.clear();
        m.trim();
...
//        m.addTo(2, 2);
//        m.addTo(3, 3);
//        ObjectBidirectionalIterator<Map.Entry<Integer, Integer>> iterator = m.entrySet().iterator(m.entrySet().last());
//        assertFalse(iterator.hasNext());
//        iterator.next();
//    }
//
...
//        m.addTo(2, 2);
//        m.addTo(3, 3);
//        ObjectBidirectionalIterator<Map.Entry<Integer, Integer>> iterator = m.entrySet().iterator();
