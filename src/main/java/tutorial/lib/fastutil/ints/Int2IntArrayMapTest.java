...
public class Int2IntArrayMapTest
{
    ...
    @Test
    void testArrayMapEmptyEntrySetThrowsExceptionOnIteratorRemove()
    {
    ...
    @Test
    void testArrayMapEmptyEntrySetThrowsExceptionTwoIteratorRemoves()
    {
    ...
    @Test
    void testArrayMapEmptyEntrySetThrowsExceptionOnFastIteratorRemove()
    {
    ...
    @Test
    void testArrayMapEmptyEntrySetThrowsExceptionTwoFastIteratorRemoves()
    {
        Int2IntArrayMap m = new Int2IntArrayMap();
        m.put(0, 0);
        m.put(1, 1);
    ...
    void testEquals()
    {
        ...
        assertFalse(m.equals(new Object2ObjectOpenHashMap<Integer, Integer>(new Integer[]{1, null}, new Integer[]{1,
                1})));
    }
    ...
    void testMap()
    {
        for (int i = 0; i <= 1; i++) {
            ...
            assertEquals(new IntOpenHashSet(i == 0 ? new int[]{1, 2, 3} : new int[]{0, 1, 2, 3}), new IntOpenHashSet
                    (m.keySet().iterator()));
            assertEquals(new IntOpenHashSet(i == 0 ? new int[]{3, 2, 3} : new int[]{0, 3, 2, 3}), new IntOpenHashSet
                    (m.values().iterator()));
