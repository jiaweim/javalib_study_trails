...
//
//        if (s.containsNull && !s.contains(null))
...
//        ) + "; actual: " + expected + "; stddev: " + Math.sqrt(totSquareProbes / m.n - expected * expected) + "; max " +
//                "probes: " + maxProbes);
//    }
...
//        for (int i = 0; i < n; i++) {
//            Object T = genKey();
//            assertTrue( m.contains(T) == t.contains(
//                    (T)));
//        }
//		/*
...
//        for (int i = 0; i < n; i++) {
//            Object T = genKey();
//            assertTrue( m.contains((T)) == t.contains((T)));
//        }
//		/*
...
//            Object T = genKey();
//            assertTrue( m.add((T)) == t.add((T)));
//            T = genKey();
//            assertTrue( m.remove((T)) == t.remove((T)));
//        }
//        assertTrue( m.equals(t));
//        assertTrue( t.equals(m));
//
...
//        Object a[] = m.toArray();
//        assertTrue( new ObjectOpenHashSet(a).equals
//                (m));
