...
public class ObjectArraysTest
{
    ...
    private static Integer[] identity(final int n)
    {
    ...
    void testMergeSort()
    {
        ...
        ObjectArrays.mergeSort(d, Integer::compareTo);
    ...
    void testQuickSort()
    {
        ...
        final Integer[] d = a.clone();
        ObjectArrays.quickSort(d, Integer::compareTo);
        assertArrayEquals(sorted, d);
    ...
    @Test
    void testLargeParallelQuickSortWithComparator()
    {
        Object[] a = new Object[8192 + 1]; // PARALLEL_QUICKSORT_NO_FORK
        for (int i = 0; i < a.length; i++) {
            a[i] = new Object();
        }
        ObjectArrays.parallelQuickSort(a, Comparator.comparingInt(System::identityHashCode));
    }

    @Test
    void testSmallParallelQuickSortWithComparator()
    {
    ...
    private final static Comparator<Integer> OPPOSITE_COMPARATOR = Comparator.reverseOrder();
    ...
    void testQuickSort2()
    {
        ...
        for (int i = d[0].length - 1; i-- != 0; )
            assertTrue(d[0][i] < d[0][i + 1] || d[0][i].equals(d[0][i + 1]) && d[1][i] <= d[1][i + 1]);
