...
public class ObjectBigArraysTest
{
    ...
    void testBinarySearch()
    {
        ...
        for (int i = -1; i < 20; i++) {
            assertEquals(Arrays.binarySearch(a, i), ObjectBigArrays.binarySearch(b, i));
            assertEquals(Arrays.binarySearch(a, i), ObjectBigArrays.binarySearch(b, i, ObjectComparators
                    .NATURAL_COMPARATOR));
        }
        ...
        for (int i = -1; i < 20; i++) {
            ...
            assertEquals(Arrays.binarySearch(a, 5, 13, i), ObjectBigArrays.binarySearch(b, 5, 13, i,
                    ObjectComparators.NATURAL_COMPARATOR));
        }
    }
