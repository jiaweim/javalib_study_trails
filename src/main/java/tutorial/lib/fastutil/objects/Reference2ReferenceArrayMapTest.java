    ...
    void testMap()
    {
        for (int i = 0; i <= 2; i++) {
            ...
            assertEquals(new ReferenceOpenHashSet<Object>(new Object[]{one, two, three}), new
                    ReferenceOpenHashSet<Object>(m.keySet().iterator()));
            assertEquals(new ReferenceOpenHashSet<Object>(new Object[]{three, two, three}), new
                    ReferenceOpenHashSet<Object>(m.values().iterator()));

            for (Entry<Object, Object> e : m.entrySet()) assertEquals(e.getValue(), m.get(e.getKey()));

            assertTrue(m.entrySet().contains(new AbstractReference2ReferenceMap.BasicEntry<Object, Object>(one,
                    three)));
            assertFalse(m.entrySet().contains(new AbstractReference2ReferenceMap.BasicEntry<Object, Object>(one, 3)));
            assertFalse(m.entrySet().contains(new AbstractReference2ReferenceMap.BasicEntry<Object, Object>(1, three)));
            ...
            assertTrue(m.entrySet().contains(new AbstractReference2ReferenceMap.BasicEntry<Object, Object>(three,
                    three)));
            assertFalse(m.entrySet().contains(new AbstractReference2ReferenceMap.BasicEntry<Object, Object>(3, two)));
