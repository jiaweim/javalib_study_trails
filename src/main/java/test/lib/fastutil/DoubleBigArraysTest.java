...
public class DoubleBigArraysTest {
    ...
    public void testBinarySearch() {
        ...
        for (int i = -1; i < 20; i++) {
            assertEquals(Arrays.binarySearch(a, i), DoubleBigArrays.binarySearch(b, i));
            assertEquals(Arrays.binarySearch(a, i), DoubleBigArrays.binarySearch(b, i, DoubleComparators
                    .NATURAL_COMPARATOR));
        }
    ...
    public void testRadixSort1() {
        ...
        for (long i = DoubleBigArrays.length(t) - 1; i-- != 0; )
            assertTrue(DoubleBigArrays.get(t, i) <= DoubleBigArrays.get(t, i + 1));
