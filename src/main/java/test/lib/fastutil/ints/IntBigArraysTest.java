...
public class IntBigArraysTest
{
    ...
    public void testBinarySearch()
    {
        ...
        for (int i = -1; i < 20; i++) {
            assertEquals(Arrays.binarySearch(a, i), IntBigArrays.binarySearch(b, i));
            assertEquals(Arrays.binarySearch(a, i), IntBigArrays.binarySearch(b, i, IntComparators.NATURAL_COMPARATOR));
        }

        for (int i = -1; i < 20; i++) {
            assertEquals(Arrays.binarySearch(a, 5, 13, i), IntBigArrays.binarySearch(b, 5, 13, i));
            assertEquals(Arrays.binarySearch(a, 5, 13, i), IntBigArrays.binarySearch(b, 5, 13, i, IntComparators
                    .NATURAL_COMPARATOR));
        }
    }
    ...
    public void testRadixSort1()
    {
        ...
        for (long i = IntBigArrays.length(t) - 1; i-- != 0; )
            assertTrue(IntBigArrays.get(t, i) <= IntBigArrays.get(t, i + 1));
    ...
    public void testRadixSort2()
    {
        ...
        for (long i = IntBigArrays.length(d) - 1; i-- != 0; )
            assertTrue(IntBigArrays.get(d, i) <
                    IntBigArrays.get(d, i + 1) || IntBigArrays.get(d, i) == IntBigArrays.get(d, i + 1) && IntBigArrays
                    .get(e, i) <= IntBigArrays.get(e, i + 1));
